...
#ifndef _SAMD21_SIM800C_H
#define _SAMD21_SIM800C_H
...
typedef	Stream 						SIM800CHwSerial;
...
class SAMD21_SIM800C 
{
 public:
  void begin(uint32_t baud); 
  SAMD21_SIM800C(HardwareSerial *ser); // Constructor when using HardwareSerial
  ...
  char read(void);
	...
	SAMD21_SIM800C():httpState(HTTP_DISABLED) {}
 ...
 private:
  ...
  HardwareSerial *SIM800CHwSerial;
